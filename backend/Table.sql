...
'part time', '8+', '2026-01-15', false, 8500, 13000, 'remote', 
...
INSERT INTO job_post (company_id, title, industry, requirements, responsibilities, employment_type, experience, created_at, removed, salary_start, salary_end, location, benefit, summary, description, contact_email) VALUES
(2, 'Senior Financial Analyst', 'Finance & Business', ARRAY['CPA or CFA certification', '5+ years in corporate finance', 'Advanced Excel and SQL skills'], ARRAY['Analyze financial performance', 'Prepare annual budgets', 'Conduct market trend research'], 'part time', '8+', '2026-01-14', false, 5000, 7500, 'remote', ARRAY['Performance bonus', 'Dental insurance'], 'Analyze market trends and provide data-driven insights for investment portfolios.', 'Join our elite finance team to drive strategic investment decisions.', 'finance.hr@finedge.com'),
...
(5, 'Content Strategist', 'Creative & Media', ARRAY['Journalism or Marketing degree', 'SEO knowledge'], ARRAY['Content planning', 'Managing writers'], 'part time', '2-5', '2026-01-16', false, 4500, 6500, 'remote', ARRAY['Internet subsidy'], 'Write and strategize compelling marketing copy for global brands.', 'Shape the voice and story of our creative agency.', 'creative.dir@artflow.com');
...
INSERT INTO job_post (company_id, title, industry, requirements, responsibilities, employment_type, experience, created_at, removed, salary_start, salary_end, location, benefit, summary, description, contact_email) VALUES
(8, 'Supply Chain Coordinator', 'Logistics & Trades', ARRAY['Logistics degree', 'ERP software skills'], ARRAY['Inventory tracking', 'Supplier negotiation'], 'part time', '2-5', '2026-01-14', false, 3800, 5500, 'remote', ARRAY['Transport allowance'], 'Optimize global shipping routes and manage supplier relationships.', 'Ensure our supply chain remains efficient and cost-effective.', 'logistics.head@logimove.com'),
